...
fileHandler = logging.handlers.TimedRotatingFileHandler('./op-log-his2-1.txt', when='H', backupCount=24)
    ...
    def read_his(self, start_date_time, end_date_time):
        ...
        try:
            ...
            if difference:
                ...
                #     key_num += 1
            while int(start_time_stamp) % 10 != 0:
                start_time_stamp += 1
            
            while start_time_stamp < end_time_stamp:
                temp = start_time_stamp + 10
...
if __name__ == '__main__':
    ...
    time_interval = 3600
    while True:
        p = mp.Process(target=worker, args=(time_interval,))
        p.start()
