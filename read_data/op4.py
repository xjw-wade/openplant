...
fileHandler = logging.handlers.TimedRotatingFileHandler('./op-log-his3.txt', when='H', backupCount=24)
...
#         point_names[points_num] = ctypes.c_char_p(str.encode(point))
...
if __name__ == '__main__':
    ...
    while start_time_stamp < end_time_stamp:
        ...
        datetime.datetime.fromtimestamp(temp), interval), error_callback=lambda x: print(x))
