...
class InfluxDBClient(object):
    ...
    def request(self, url, method='GET', params=None, data=None, stream=False,
        ...
        :raises InfluxDBServerError: if the response code is any server errors
            code (5xx)
        :raises InfluxDBClientError: if the response code is not the
            same as `expected_response_code` and is not a server errors code
        """
        ...
        # if there's not an errors, there must have been a successful response
